 ...
 * SSH commands. It has added wait times in case the remote host can't handle to many
 * SSH commands in a short time.
 ...
 *
 * vendor\bin\dep -f={filepath} LocalBldSshInstallWait --build {build}
 *
